...
原廠亞鉛槍機撞鋼擊錘滾輪會撞的咪咪冒冒，改鋼槍機換成原廠亞鉛擊錘上面補強的凸被尻凹(改裝件記得挑沒這塊的)(bolt也有同樣的問題)                        
原廠司牙角度抓的過於剛好不能容下一點油汙或變形，會容易造成卡扳機(得自己推回去復位)(bolt也有同樣的問題)                        
...
目前已知原廠狀態小毛病:
  ...
  hop座基於歷史遺留問題有上彈過深+下壓點過深問題導致其原廠管皮跟改裝管皮都無法完整發揮其效果所以這裡只保證運作不保證彈道
### V2
...
此設計基於擊錘預壓量增加了導致其擊錘安裝更加不易且擊錘簧壽命、box殼壽命更短了
  
  如運氣不佳遇到模具嚴重損耗導致的溢料火控，很可能造成擊錘卡死半自動無法正常擊發，可拆下打磨掉溢料來解決此問題，或者直接改鋼
  
  2025/12更新V3.1，新增原廠更新鋼火控，後定網球拍連動功能，終於從抽象玩意變成正常玩意了，但是hop座、buffer止擋部分問題依舊
...
更新，GHK HK416A5前段總成可直上VFC HK416A5
再更新，楓葉出了可改善VFC HK416的槍管尾段，可通用ARhop座

### EVO
先不管專利跟別人打到的問題，目前已有鬆動問題，且VFC上彈過推史遺留問題他們這次做死整上了空心單點下壓豆這個問題又回歸來了，本來採用兩顆超小止付螺絲固定防止內抽，新版EVO 2.0又修改成兩側凸榫固定，現在就怕爛料久了撞鬆動了
...
### V3
飛機頭出氣嘴加長對應GBB皮壓點了
彈匣氣槽內多了隔斷可不用再四秒傳奇了，當前V3(當它2.99四捨五入)版彈匣輸出量明顯比舊版來的小，不建議彈匣混用免的一把槍多種彈道
仿真滑塊緩衝buffer可有效減少槍機彈跳了，不需要再靠斜屁股槍機來硬幹了(舊設計是利用斜屁股造成額外摩擦力來跟反作用力互幹)不過建議將滑塊更換成小鋼珠或者其它可多段撞擊的物件
擊錘簧復進簧皆加粗0.1mm
撞塊修改形狀避免加硬擊錘簧後上匣走火
擊錘脫蠟件表面光度修正

當前V3開模精度有所控制，比往常V2穩定的多

DD PDW目前有後定異常磨耗問題，建議直接拔了後定磁鐵(或者把它燒到消磁)，這辦法也是V2後定異常的老解法了
GHK HK416A5後定直接沒磁鐵，目前表現最好

DDPDW(第一批)的槍機屁股是∅19孔的配重塊+銑破的槍機殼，跟後期的∅18配重塊槍機不銑破的不同

2026預計更新V3.1版火控(MIM火控，精度提升)，V3.1彈匣(跟AK同架構)
...
當前最大的災情，MIM鋼件的鋼性不足導致能被它亞鉛的其他火控零件壓到變形，尤其是司牙，造成半自動異常(多連發之類的)

雙邊款的因為綁定其槍機釋放扭的關係所以後定片無法改裝
原廠後定片建議將原廠後定片緩衝彈簧剪兩半前後都安裝上好避免後定片過衝撞擊到彈匣外殼(尤其是非原廠、警星彈匣)

單邊款最快的解法是直接將整個火控box改成其他牌子的改裝品，因為原廠沒有修正任何MWS原廠的錯誤設計，依舊會出現司牙沾黏擊錘、擊錘被槍機干涉撞擊的問題(上述Marui條目亦有記載)
